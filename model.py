...
def model1(alpha, theta, psi, phi, tdoa, var_tdoa, rho, d1, P, c, iterprint):
    ...
    history_1, elasped_loop_1, iterations_1 = loop_step_for_GAMP_1(Q0_1, w0_1, v0_1, var_B_1, config_SC.TOL, alpha, theta, psi, phi, tdoa, var_tdoa, rho, d1, P, c, iterprint)
...
def model2(alpha, theta, psi, phi, tdoa, var_tdoa, rho, d1, P, c, iterprint):
    ...
    history_2, elasped_loop_2, iterations_2, M, G = loop_step_for_GAMP_2(Q0_2, w0_2, v0_2, var_B_2, config_SC.TOL, alpha, theta, psi, phi, tdoa, var_tdoa, rho, d1, P, c, iterprint)
